...
export default function AddContentPage() {
  ...
  return (
    <Modal>
      <form
        className="mx-auto rounded-lg border-t-[6px] border-[#8a1538] p-4 shadow-2xl max-h-[80vh] overflow-y-scroll"
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-2 w-full md:h-auto">
              <Textarea
                ...
                className="mt-2 max-w-[760px] cursor-text resize-none rounded-lg p-2 text-gray-900 focus:outline-none focus-visible:ring-0 md:min-h-[10rem] md:min-w-[30rem] md:resize md:max-h-[250px]"
                id="body"
